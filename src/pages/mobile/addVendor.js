  ...
  return (
    <div>
        ...
        <div className=" p-10 w-full lg:w-4/5">
          <div className="flex">
          <input className="rounded-l-md outline-none px-5 py-2 w-full lg:w-80" type="text" placeholder="Look for Vendors" style={{ backgroundColor : "#EAE4DA" ,placeholder : "#AAAAAA"}}></input>
          <input className="outline-none px-5 py-2 w-full lg:w-40" type="text" placeholder="Where" style={{ backgroundColor : "#EAE4DA" ,placeholder : "#AAAAAA"}}></input>
