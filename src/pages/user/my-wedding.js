  ...
  return (
    <>
      ...
      <div className="">
          ...
          <div className="bg-bg bg-center object-contain h-full h-80">
            </div>
          </div>
          ...
          <div style={{ backgroundColor : "#F5F1EA" }} className="flex flex-col lg:flex-row justify-center items-center p-5">
            ...
            <div className="bg-white w-full m-3 lg:mr-10 shadow-lg relative bottom-40">
              ...
              <div className="flex my-12">
                <div style={{ backgroundColor : "#AAAAAA" }} className="w-full h-0.5 mx-10">
            ...
            <div className="w-full flex lg:flex-row flex-col text-white">
              ...
              <div className="m-4 w-40 h-40 lg:w-60 lg:h-60 flex flex-col justify-center items-center bg-business relative m-4">
                <p style={{ bottom : 0 }} className="text-white text-xl mt-2 absolute font-bold">Business Name</p>
              </div>
              </div>
              <div className="flex">
          ...
          <div className="bg-bg-primary w-full text-white flex flex-col lg:flex-row">
            <div className="p-10 w-full">
              ...
              <div className="mt-8">
                <button className="w-40 h-10  font-bold" style={{ backgroundColor : "#DBA8A1" }}>View All Tasks</button>
              </div>
            </div>
            ...
            <div className="p-10 lg:pl-0 w-full">
              ...
              <div className="mt-8">
                <button className="w-40 h-10  font-bold" style={{ backgroundColor : "#DBA8A1" }}>Manage Guests</button>
              </div>
            </div>
