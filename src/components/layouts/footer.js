  ...
  return (
    <div className="bg-bg-primary w-full px-5 py-2 text-white">
      ...
      <div className="flex w-full mt-2">
        <div className="border-y-0.5 border-r-0.5 border-gray-400 w-1/4">
          <div className="border-b-0.5 border-gray-400 flex justify-center py-2">
        ...
        <div className="border-y-0.5 border-gray-400 w-1/4">
          <div className="border-b-0.5 border-gray-400 flex justify-center py-2">
