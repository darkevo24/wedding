      ...
      <div className="md:flex w-3/4 justify-between hidden">
        <div>
          <div className="flex items-center">
            ...
            <label htmlFor="billboard" className="ml-2">
              MRT/Billboard
            </label>
          </div>
          <div className="flex items-center">
        ...
        <div>
          ...
          <div className="flex items-center">
            ...
            <label htmlFor="facebook" className="ml-2">
              Facebook
            </label>
          </div>
          <div className="flex items-center">
            <input type="checkbox" id="pinterest" className="w-4 h-4 rounded-md" />
            <label htmlFor="pinterest" className="ml-2">
              Pinterest
            </label>
          </div>
        </div>
        <div>
          ...
          <div className="flex items-center">
            ...
            <label htmlFor="podcast" className="ml-2">
              Podcast
            </label>
          </div>
        </div>
