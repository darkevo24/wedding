        ...
        <div className="flex mt-3">
          ...
          <div className="mx-2 flex flex-col space-y-3">
            ...
            <div className="w-full flex justify-end">
              <div className="flex justify-end items-center mt-2 space-x-2 transition-all hover:scale-110 cursor-pointer select-none">
